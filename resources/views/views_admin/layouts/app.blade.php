...
<html lang="es">
    ...
    @include('views_admin.layouts.src.head')
    ...
    <body data-topbar="colored" class="bg-pattern gorgias-loaded">
        ...
        <div id="layout-wrapper">
            ...
            @include('views_admin.layouts.src.header')

            <!-- ========== Left Sidebar Start ========== -->
            @include('views_admin.layouts.src.menu')
            <!-- Left Sidebar End -->
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">Medicexpress.</h4>
        ...
        @include('views_admin.layouts.src.modal')

        <!-- Right bar overlay-->
        <div class="rightbar-overlay"></div>

        <!-- JAVASCRIPT -->
        @include('views_admin.layouts.src.footer')
